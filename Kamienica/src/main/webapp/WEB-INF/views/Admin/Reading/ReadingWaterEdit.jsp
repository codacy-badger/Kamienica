...
<body>
	<center>
		<br> <br> <br> <br> <br> <br>
		<div style="color: teal; font-size: 30px">Edycja Odczytów Wody</div>
		<br> <br>

		<c:url var="odczyty" value="/Admin/Reading/readingWaterOverwrite.html" />
		...
		<br> <br> <br> <a href="../home.html">Strona
			Główna</a>
	</center>
</body>
</html>