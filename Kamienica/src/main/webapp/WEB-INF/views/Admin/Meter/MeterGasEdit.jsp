...
<body>
	<center>
		<br> <br> <br> <br> <br> <br>
		<div style="color: teal; font-size: 30px">Edycja Licznika Gazu</div>
		<br> <br>
		<c:url var="licznikGazEdytuj" value="/Admin/Meter/meterGasOverwrite.html" />
		<form:form id="licznikGazEdytuj" modelAttribute="meter" method="post"
			...
			<table width="400px" height="150px">
				...
				<tr>
					<td><form:label path="cwu">czyDoCWU</form:label></td>
