...
<body ng-app="myApp">
			...
			<div id='form' class="fadein fadeout showpanel panel row"
				...
				<form class="form-horizontal" ng-submit="ctrl.submit()"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" ng-model="ctrl.meterEnergy.unit"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select name='apartment' ng-model="ctrl.meterEnergy.apartment"
								ng-required='true' class="form-control"
								ng-options="a.description for a in ctrl.apartments"><option>{{ctrl.tenant.apartment}}</option>
							</select>
							<p class="help-block">
								<span class='error' ng-show="myForm.meterEnergy.$invalid">Pole
			...
			<div id='list' class="row fadein fadeout showpanel panel"
				...
				<div>
					<table class='table table-stripped table-hover'>
						...
						<tbody>
							<tr ng-repeat="a in ctrl.meterEnergys">
	...
	<script
		src="<c:url value='/static/angular/meterEnergy/meterEnergy_controller.js' />"></script>
	<!-- jQuery -->
