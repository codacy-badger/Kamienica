...
<body>
	...
	<div class='container'>
		<div class='row'>
			<div class='jumbotron'>
				<h1>Odczyty Wody</h1>
				<a href="readingWaterRegister.html">Dodaj Odczyty Wody</a><br>
			</div>
		</div>
				...
				<table class='table table-stripped table-hover' width="100%">
					...
					<c:forEach items="${reading}" var="reading">
						<tr>
							...
							<td><a
								href='<c:url value="/Admin/Reading/readingWaterEdit.html?date=${reading.readingDate}" />' role="button"
								class="btn-xs btn-warning">Edytuj</a></td>
							<td><a
								href='<c:url value="/Admin/Reading/readingWaterDelete.html?date=${reading.readingDate}"  />' role="button"
