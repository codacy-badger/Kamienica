        ...
        <%@ taglib prefix="mytags" tagdir="/WEB-INF/tags"%>
            <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
                ...
                <head>
                    ...
                    <script src="<c:url value='/static/angular/invoice/gas/baseReading_service.js' />"></script>
                    <script src="<c:url value='/static/angular/invoice/gas/invoice_service.js' />"></script>
                    <script src="<c:url value='/static/angular/invoice/gas/invoice_controller.js' />"></script>
                    <!-- jQuery -->
                        ...
                        <div id="page-wrapper" ng-controller="InvoiceController as ctrl">
							...
							Wystawienia</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name='apartment' ng-model="ctrl.invoice.baseReading" ng-required='true' class="form-control" ng-options="a.readingDate for a in ctrl.readings"><option>{{ctrl.inovice.readings}}</option>
							</select>
                                            <p class="help-block">
