                        ...
                        <div id="page-wrapper" ng-controller="TenantController as ctrl">
                            <div class='row'>
                                <div class="col-lg-12">
                                    ...
                                    <button id='mySwitch' ng-click="toggle = !toggle" class="btn btn-default btn-sm">{{text}}</button>
                                    ...
                                    <table class='table table-stripped table-hover'>
                                        ...
                                        <tbody>
                                            <tr ng-repeat="t in ctrl.tenants">
                                                <td><span ng-bind="t.firstName"></span> <span ng-bind="t.lastName"></span></td>

                                                <td><span ng-bind="t.email"></span></td>
                                                <td><span ng-bind="t.phone"></span></td>
                                                <td>
                                                    {{t.rentContract.apartment.residence.street}} {{t.rentContract.apartment.residence.number}}, {{t.rentContract.apartment.residence.city}}- {{t.rentContract.apartment.description}} </td>
                                                <td><span ng-bind="t.rentContract.rentCost"></span></td>
                                                <td><span ng-bind="t.rentContract.contractStart"></span></td>
                                                <td><span ng-bind="t.rentContract.contractEnd"></span></td>
                                                <td>
                                                    <button type="button" ng-click="ctrl.edit(t.id, $index)" class="btn-xs btn-warning">
										<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
									</button>
                                                    <button type="button" ng-click="ctrl.remove(t.id, $index)" class="btn-xs btn-danger ">
                            ...
                            <div id='form' class="fadein fadeout showpanel panel row" ng-show="!toggle">
                                ...
                                <form class="form-horizontal" ng-submit="ctrl.submit()" name="myForm">
                                    <input path="id" readonly="true" type='hidden' /> <input type="hidden" ng-model="ctrl.id" />
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Imię</label>
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.tenant.firstName" class="form-control" name="firstName" ng-required='true' ng-minlength="4" />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.tenant.lastName" class="form-control" name="lastName" path='lastName' ng-required='true' ng-minlength="4" />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" ng-model="ctrl.tenant.email" class="form-control" name="email" path='email' ng-required='true' />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.tenant.phone" class="form-control" path='phone' placeholder="Opcjonalne" name="phone" ng-pattern="/^[0-9]{1,12}$/" ng-min=0 />
								...
								<option ng-repeat="option in ctrl.apartments"
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-3 control-label">Początek Umowy</label>
                                        <div class="col-sm-9">
                                            <input type="text" datetime="yyyy-MM-dd" ng-model="ctrl.tenant.rentContract.contractStart" class="form-control" placeholder="YYYY/MM/DD" name="contractStart" ng-required='true' />
                                            <p class="help-block">
                                                <span class='error' ng-show="myForm.contractStart.$invalid">Pole
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.tenant.password" class="form-control" name="password" ng-required='true' ng-minlength="5" value='witaj' />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group ">
                                        <div class="col-lg-12">
                                            <input type="submit" value="{{!ctrl.tenant.id ? 'Dodaj' : 'Nadpisz'}}" class="btn btn-default " ng-disabled="myForm.$invalid">
                                            <button type="button" ng-click="ctrl.reset()" class="btn btn-default " ng-disabled="myForm.$pristine">Reset
							</button>
                                        </div>
                                    </div>
                                </form>
