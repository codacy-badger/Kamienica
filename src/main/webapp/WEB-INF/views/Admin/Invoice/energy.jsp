        ...
        <%@ taglib prefix="mytags" tagdir="/WEB-INF/tags"%>
            <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
                ...
                <body ng-app="myApp">
                        ...
                        <div id="page-wrapper" ng-controller="InvoiceController as ctrl">
                            ...
                            <div id='form' class="fadein fadeout showpanel panel row" ng-show="!toggle">
                                ...
                                <form class="form-horizontal" ng-submit="ctrl.submit()" name="myForm">
                                    ...
                                    <input path="id" readonly="true" type='hidden' /> <input type="hidden" ng-model="ctrl.invoice.id" />

                                    <div class="form-group">
                                        <label for="serialNumber" class="col-sm-3 control-label">Numer
							Faktury</label>
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.invoice.serialNumber" class="form-control" path='serialNumber' placeholder="Pole wymagane" ng-required='true' name="serialNumber" />
                                            <p class="help-block">
							...
							Wystawienia</label>
                                        <div class="col-sm-9">
                                            <input type="text" datetime="yyyy-MM-dd" ng-model="ctrl.invoice.date" class="form-control" path='date' placeholder="YYYY/MM/DD" name="date" ng-required='true' />
                                            <p class="help-block">
							...
							Faktury</label>
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.invoice.totalAmount" class="form-control" path='totalAmount' name="totalAmount" ng-pattern="/^[0-9]{1,12}$/" ng-min=0 ng-required='true' />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name='baseReading' ng-model="ctrl.invoice.baseReading" ng-required='true' class="form-control" ng-options="a.readingDate for a in ctrl.readings"><option>{{ctrl.inovice.readings}}</option>
							</select>
                                            <p class="help-block">
                                    ...
                                    <table class='table table-stripped table-hover'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr ng-repeat="a in ctrl.invoices">
                                                ...
                                                <td><span ng-bind="a.invoiceDate"></span></td>
                                                <td><span ng-bind="a.totalAmount"></span></td>
                                                <td>{{a.residence.street}} {{a.residence.number}}, {{a.residence.city}} 
                                                </td>
                                                <td><span ng-bind="a.media"></span></td>
                                                <td>
                    ...
                    <script src="<c:url value='/static/angular/invoice/energy/baseReading_service.js' />"></script>
                    <script src="<c:url value='/static/angular/invoice/energy/invoice_service.js' />"></script>
                    <script src="<c:url value='/static/angular/invoice/energy/invoice_controller.js' />"></script>
                    <!-- jQuery -->
