...
<body>
	<div id="mainWrapper">
		<h1>Liczniki Energii</h1>
		<hr>
		<a href="../home.html">Strona Główna</a> <br> <a
			href="meterEnergyRegister.html">Dodaj Licznik Energii</a>
			<br>
			...
			<table width="100%">
				...
				<c:forEach items="${meter}" var="meter">
					<tr>
						...
						<td><a
							href="<c:url value="/Admin/Meter/meterEnergyDelete.html?id=${meter.id}"  />"
							onclick="return confirm('Na pewno usunąć?')">Usuń</a></td>
						<td><a
							href="<c:url value="/Admin/Meter/meterEnergyEdit.html?id=${meter.id}" />">Edytuj</a></td>
					</tr>
				</c:forEach>
			</table>
		</c:if>
