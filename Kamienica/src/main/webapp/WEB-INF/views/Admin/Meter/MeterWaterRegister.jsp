	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class='row'>
				<div class='row'>
					<div class="col-lg-12">
						<h1 class="page-header well">Formularz Licznika Wody</h1>
					</div>
				</div>
			</div>
			<div class='row'>
			...
			<div class='row'>
				<c:if test="${empty model.error}">
					<c:url var="rejestrujLicznikWoda" value="${model.url }" />
					<form:form id="rejestrujLicznikWoda" modelAttribute="meter"
						method="post" class="form-horizontal"
						action="${rejestrujLicznikWoda}">
						...
						<div class="form-group">
							<label for="isWarmWater" class="col-sm-3 control-label">Woda
								Ciepła</label>
							<div class="col-sm-9">
								<form:radiobuttons class="radio-inline" path="isWarmWater"
									items="${model.tf}" />
								<p class="help-block">
