...
<body>
	<center>
		...
		<c:url var="rejestrujLicznikGaz" value="/Admin/Meter/meterGasSave.html" />
		<form:form id="rejestrujLicznikGaz" modelAttribute="meter"
			method="post" action="${rejestrujLicznikGaz}">
			<table width="400px" height="150px">
				...
				<tr>
					<td><form:label path="cwu">CWU</form:label></td>
					<td><form:radiobuttons path="cwu" items="${model.tf}" /></td>
					<td><form:errors path="cwu" cssClass="error" /></td>
				</tr>
				<tr>
					<td></td>
