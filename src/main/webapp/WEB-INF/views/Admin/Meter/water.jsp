<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="<c:url value='/static/js/angular.js' />"></script>
                    ...
                    <script src="<c:url value='/static/angular/apartment/apartment_controller.js' />"></script>
                    <script src="<c:url value='/static/angular/meterWater/meterWater_service.js' />"></script>
                    <script src="<c:url value='/static/angular/meterWater/meterWater_controller.js' />"></script>
                    <!-- jQuery -->
                        ...
                        <div id="page-wrapper" ng-controller="MeterWaterController as ctrl">
                            ...
                            <div id='form' class="fadein fadeout showpanel panel row" ng-show="!toggle">
                                ...
                                <form class="form-horizontal" ng-submit="ctrl.submit()" name="myForm">
                                    <input path="id" readonly="true" type='hidden' /> <input type="hidden" ng-model="ctrl.meterWater.id" />


                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">Opis</label>
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.meterWater.description" class="form-control" name="description" ng-required='true' ng-minlength="4" />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.meterWater.serialNumber" class="form-control" name="serialNumber" path='serialNumber' ng-required='true' ng-minlength="1" />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" ng-model="ctrl.meterWater.unit" class="form-control" name="unit" path='unit' ng-required='true' />
                                            <p class="help-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name='apartment' ng-model="ctrl.meterWater.apartment" class="form-control" ng-options="a.description for a in ctrl.apartments"><option>{{ctrl.tenant.apartment}}</option>
							</select>
                                            <p class="help-block">
								...
								ng-model="ctrl.meterWater.isWarmWater" ng-value="false">NIE
                                    ...
                                    <div class="form-group ">
                                        <div class="col-lg-12">
                                            <input type="submit" value="{{!ctrl.meterEnergry.id ? 'Dodaj' : 'Nadpisz'}}" class="btn btn-default " ng-disabled="myForm.$invalid">
                                    ...
                                    <table class='table table-stripped table-hover'>
                                        ...
                                        <tbody>
                                            <tr ng-repeat="a in ctrl.meterWaters">
                                                ...
                                                <td><span ng-bind="a.warmWater"></span></td>
                                                <td>
