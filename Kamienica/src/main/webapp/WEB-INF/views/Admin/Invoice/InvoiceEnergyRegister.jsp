...
<body>
	<center>
		<br> <br> <br> <br> <br> <br>
		<div style="color: teal; font-size: 30px">Rejestracja Nowej Faktury Energii</div>
		<br> <br>

		<c:url var="register" value="/Admin/Invoice/invoiceEnergySave.html" />
		<form:form id="register" modelAttribute="invoice"
			...
			<table width="400px" height="150px">
				...
				<tr>
					...
					<td><form:input path="description" value="${model.description }" /></td>
				...
				<tr>
					...
					<td><form:input path="totalAmount"   required="true"  /></td>
